...
<mark style="color:purple;">**11**</mark> - Le **MassRP** : Le MassRP consiste à simuler la présence de milliers de civils partout en ville : elle n'est pas peuplée uniquement de joueurs. Il s'applique dans toute la zone signalée par les panneaux « LBRP City », petites rues comprises (derrière la banque, le concessionnaire, l'hôpital). Les actions comme le braquage de banque y restent possibles.
...
Vous avez obligation d'avoir une conduite RP sur le serveur. (Exemple : Utiliser le nitro pour pit un véhicule perso -> interdit)
...
Si vous souhaitez construire votre maison sans être braqué, vous devez placer un textscreen au-dessus de la porte indiquant que vous êtes "en construction". Durant cette période, vous n'avez pas le droit de farmer (printers / bitminers / drogue / etc ...).
